  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('student.actions')" align="center" min-width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">un
          ...
          <el-button size="mini" type="danger" @click="">{{ $t('student.delete') }}
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('student.date')" prop="timestamp">
        ...
        <el-form-item :label="$t('student.department')">
          <el-rate v-model="temp.department" :colors="['#99A9BF', '#F7BA2A', '#FF9900']" :max="3" style="margin-top:8px;"/>
        </el-form-item>
        <el-form-item :label="$t('student.remark')">
